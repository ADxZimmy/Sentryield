...
// In Railway, always prefer the platform-assigned PORT so healthchecks route correctly.
process.env.BOT_STATUS_PORT = process.env.PORT || process.env.BOT_STATUS_PORT || "8787";
